...
<select class="btn" name="sortby" id="sortby" onchange="form.submit();" ><option value="">Sort By</option><option value="file_name">Name</option><option value="file_size">Size</option><option value="reg_date">Date created</option><option value="file_type">File type</option></select>
</form>
...
<button type="submit" value="Create Folder" class="create" name="create"><i class="fa fa-folder" aria-hidden="true"></i>Create</button>
</form>
