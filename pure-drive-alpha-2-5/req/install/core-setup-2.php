...
if (isset($_POST['submit'])){
    ...
    $result = $conn->prepare("INSERT INTO core_options (options, setting) VALUES ('logo', '../req/css/cc.png')");
    $result->execute();
    $result->setFetchMode(PDO::FETCH_ASSOC);
    ...
    $result = $conn->prepare("INSERT INTO core_options (options, setting) VALUES ('gd', 'Disable')");
    $result->execute();
    $result->setFetchMode(PDO::FETCH_ASSOC);
}
