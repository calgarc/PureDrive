...
function renamepopup(btn) {
        ...
        var nid = $('.profiledown').attr('value');
        
        $.ajax({
        type: 'get',
        url: '../req/ajax',
        data:{phpget: 14, name: name, nid: nid },
...
function rnamefiles() {
    $('.renamebtn').click( function() {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpfunc: 14, rename: rename, name: name, nid: nid},
        ...
        type: 'get',
        url: '../req/ajax',
        data:{phpget: 7, id: id, nid: nid, sortlink: sortlink, sorted: sorted },
...
function searchl(search) {
    ...
    type: 'post',
    url: '../req/ajax',
    data:{phpfunc: 5, query: query, nid: nid, sorted: sorted},
...
function searchg(search) {
    ...
    type: 'post',
    url: '../req/ajax',
    data:{phpfunc: 6, query: query, nid: nid, sorted: sorted},
...
function loaddir() {
    $('.columnd').dblclick( function() {
        ...
        type: 'get',
        url: '../req/ajax',
        data:{phpget: 7, id: id, nid: nid, sorted: sorted},
...
function loadgrid() {
    $('.columng').dblclick( function() {
        ...
        type: 'get',
        url: '../req/ajax',
        data:{phpget: 8, id: id, nid: nid, sorted: sorted},
...
function addfav(btn) {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpfunc: 10, fav: fav, sorted: sorted},
...
function deletefiles() {
    $('.deletebtn').mousedown( function() {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpfunc: 11, deleted: deleted},
...
function sortby() {
    $('.deletebtn').mousedown( function() {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpget: 7, id: id, sortby: sortby, sorted: sorted},
...
function listview() {
    $('.btnlist').mousedown( function() {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpfunc: 12, disp: disp, sorted: sorted},
...
function gridview() {
    $('.btngrid').mousedown( function() {
        ...
        type: 'post',
        url: '../req/ajax',
        data:{phpfunc: 12, disp: disp, sorted: sorted, nid: nid},
