...
echo '<link rel="stylesheet" href="'.$root.'req/css/styles.css">';
}
?>
...
<script src="<?php echo $root; ?>req/js/external/jquery/jquery.js"></script>-->
...
$result = $conn->prepare("SELECT usalt, core_username, core_avatar, core_email FROM core_users WHERE core_username='".$username."'");
$result->execute();
$result->setFetchMode(PDO::FETCH_ASSOC);
$r = $result->fetch();
...
echo '<div id="mobile" style="display:none;" ><div id="mobileinner"> 
    ...
    <a href="updateuser?id='.$r['usalt'].'" ><img class="loggedin" src="'.substr($root, 0, -3).$r['core_avatar'].'" /></a>
    <i class="fas fa-arrow-circle-left" onclick="mobilebar()"></i>
    <span>'.$username.'</span><span>'.$r['core_email'].'</span>
    </div>
    
    <div class="mobilenav">
    <a href="updateuser?id='.$r['usalt'].'" class="detbtn"><i class="fa fa-user"></i><span>Profile</span></a>
...
<div id="tabs"> <!--tabs-->
    ...
    if (ismobile()) {
        ...
        echo '<li class="'.$users.'"><a href="'.$root.'drive/users"><i class="fa fa-users"></i></a></li>';
        }
    }
    ?>
    ...
    echo '<li id="undsh" class="active" style="display:none;"><a href="#" onclick="closedash();"><i class="fa fa-th-large"></i></a></li>';
        ...
        if ($admin == 'Administrator') {
        echo '<li class="'.$settings.'" ><a href="'.$root.'drive/settings"><i class="fa fa-cog"></i></a></li>';
        echo '<li class="'.$plugins.'" ><a href="'.$root.'drive/plugins"><i class="fa fa-plus-square"></i></a></li>';
        echo '<li class="'.$trash.'" ><a href="'.$root.'drive/trash?id=drives"><i class="fa fa-trash"></i></a></li>';
        }
    }
    ?>
    <li class="<?php echo $photos; ?>"><a href="<?php echo $root; ?>drive/photos"><i class="fa fa-camera"></i></a></li>
...
<div id="aniout" style="display:none;">
    <div id="anicont">
        <div class="item"><img src="<?php echo $root; ?>req/load.png" /></div>
