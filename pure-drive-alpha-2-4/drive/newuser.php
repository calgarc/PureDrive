...
if (isset($_POST['submit'])){
    $result = $conn->prepare("INSERT INTO core_users (usalt, core_username, core_firstname, core_lastname, core_pass, core_email, salt, core_avatar, user_type, disp_type, uplimit) VALUES ('".salted()."','".$_POST["user"]."','".$_POST["first"]."','".$_POST["last"]."','$user_password','".$_POST["email"]."','$salted','$avatar','standard', 'listview', '0.5')");
    $result->execute();
